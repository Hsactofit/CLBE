...
class WageTierPublic(CamelModel):
    wage_tier_1: float = Field(..., description="Wage tier 1")
    wage_tier_2: float = Field(..., description="Wage tier 2")
    wage_tier_3: float = Field(..., description="Wage tier 3")
    wage_tier_4: float = Field(..., description="Wage tier 4")
...
class WageTiersPublic(CamelModel):
    tiers: list[WageTierPublic] = Field(..., description="List of wage tiers")
