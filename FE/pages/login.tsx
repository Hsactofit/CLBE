...
export default function LoginPage() {
  ...
  const { isSignedIn, isLoaded: isSignedInLoaded } = useAuth()
      ...
      signIn
        ...
        .then(async result => {
          try {
            ...
            console.warn('setActive failed (continuing to redirect):', err)
          }
          // Check if there's a redirect URL in the query params
          const redirectUrl = router.query.redirect_url as string
          const destination = redirectUrl || '/projects'
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      const redirectUrl = router.query.redirect_url as string
      const destination = redirectUrl || '/sso-callback'
  ...
  // Manual function to clear stuck auth state
        ...
        <div className="max-w-md w-full mx-auto px-6">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <div className="text-center mb-6">
              ...
              {isSignedInLoaded && !isSignedIn && (
                <p className="text-sm text-gray-600">Please enter your credentials below</p>
              )}
            </div>
            {(!isSignedInLoaded || isSignedIn) && (
              <ShimmerLoader lines={4} items={1}></ShimmerLoader>
            )}
            ...
            {isSignedInLoaded && !isSignedIn && (
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                {/* Clear session button for stuck auth */}
                <div className="pt-2">
                  <button
                    type="button"
                    onClick={clearStuckAuth}
